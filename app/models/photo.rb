...
class Photo < ApplicationRecord
  ...
  #Photo has a belongs_to association defined called 'poster' with Class name 'User' and foreign key 'owner_id'

  belongs_to( :poster, class_name: "User", foreign_key: "owner_id" )

  # Photo#comments: returns rows from the comments table associated to this photo by the photo_id column
  # Photo has a has_many association defined called 'comments' with Class name 'Comment' and foreign key 'photo_id' 

  has_many( :comments, class_name: "Comment", foreign_key: "photo_id" )


  # Photo#likes: returns rows from the likes table associated to this photo by the photo_id column
  #Photo has a has_many association defined called 'likes' with Class name 'Like' and foreign key 'photo_id'
 ...
 # def likes
  ...
  #Photo has a has_many (many-to_many) association defined called 'fans' through 'likes' and source 'fan' 
